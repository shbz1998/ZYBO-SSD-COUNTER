...
HD_PWD='C:/Users/malik/Documents/ECE_520_PROJECTS/FINAL/FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MY_SSD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MY_SSD_wrapper.tcl
