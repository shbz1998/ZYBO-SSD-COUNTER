...
HD_PWD='C:/Users/malik/Documents/ECE_520_PROJECTS/FINAL/FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MY_SSD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MY_SSD_wrapper.tcl -notrace
