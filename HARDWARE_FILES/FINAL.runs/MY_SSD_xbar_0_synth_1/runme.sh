...
HD_PWD='C:/Users/malik/Documents/ECE_520_PROJECTS/FINAL/FINAL.runs/MY_SSD_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MY_SSD_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MY_SSD_xbar_0.tcl
